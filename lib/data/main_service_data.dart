...
import 'package:prototype_posyandu/screens/examination_recap_screen.dart';
import 'package:prototype_posyandu/screens/education_screen.dart';
...
class MainServiceData {
  ...
  MainServiceData(
      {required this.imagePath, required this.title, this.navigation});
}
...
final List<MainServiceData> mainServices = [
  ...
  MainServiceData(
      ...
      navigation: const ExaminationRecapScreen()),
  MainServiceData(
      imagePath: 'assets/images/main_service/edukasi.jpeg',
      title: 'Edukasi',
      navigation: const EducationScreen()),
];
